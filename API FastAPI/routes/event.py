...
def create_event(this_event: EventSchema):
    ...
    # Ejecuta una consulta de la tabla de usuarios en donde el id de todos los usuarios coincida con el id
    # que se acaba de guardar, solo va a traer el id que coincida. Y como devuelve una lista, con first() le digo que solamente devuelta el primero
